...
- (id)init
{
	if (self = [super init]) {
		...
		_rgbaUIColorRegex = [[NSRegularExpression regularExpressionWithPattern:@"(\\[\\s*UIColor\\s+colorWith|\\[\\s*\\[\\s*UIColor\\s+alloc\\]\\s*initWith)Red:\\s*([0-9]*\\.?[0-9]*[Ff]?)\\s*(\\/\\s*[0-9]*\\.?[0-9]*[Ff]?)?\\s+green:\\s*([0-9]*\\.?[0-9]*[Ff]?)\\s*(\\/\\s*[0-9]*\\.?[0-9]*[Ff]?)?\\s+blue:\\s*([0-9]*\\.?[0-9]*[Ff]?)\\s*(\\/\\s*[0-9]*\\.?[0-9]*[Ff]?)?\\s*alpha:\\s*([0-9]*\\.?[0-9]*[Ff]?)\\s*(\\/\\s*[0-9]*\\.?[0-9]*[Ff]?)?\\s*\\]" options:0 error:NULL] retain];
		_whiteUIColorRegex = [[NSRegularExpression regularExpressionWithPattern:@"(\\[\\s*UIColor\\s+colorWith|\\[\\s*\\[\\s*UIColor\\s+alloc\\]\\s*initWith)White:\\s*([0-9]*\\.?[0-9]*[Ff]?)\\s*(\\/\\s*[0-9]*\\.?[0-9]*[Ff]?)?\\s+alpha:\\s*([0-9]*\\.?[0-9]*[Ff]?)\\s*(\\/\\s*[0-9]*\\.?[0-9]*[Ff]?)?\\s*\\]" options:0 error:NULL] retain];
		_rgbaNSColorRegex = [[NSRegularExpression regularExpressionWithPattern:@"\\[\\s*NSColor\\s+colorWith(Calibrated|Device)Red:\\s*([0-9]*\\.?[0-9]*[Ff]?)\\s*(\\/\\s*[0-9]*\\.?[0-9]*[Ff]?)?\\s+green:\\s*([0-9]*\\.?[0-9]*[Ff]?)\\s*(\\/\\s*[0-9]*\\.?[0-9]*[Ff]?)?\\s+blue:\\s*([0-9]*\\.?[0-9]*[Ff]?)\\s*(\\/\\s*[0-9]*\\.?[0-9]*[Ff]?)?\\s+alpha:\\s*([0-9]*\\.?[0-9]*[Ff]?)\\s*(\\/\\s*[0-9]*\\.?[0-9]*[Ff]?)?\\s*\\]" options:0 error:NULL] retain];
		_whiteNSColorRegex = [[NSRegularExpression regularExpressionWithPattern:@"\\[\\s*NSColor\\s+colorWith(Calibrated|Device)White:\\s*([0-9]*\\.?[0-9]*[Ff]?)\\s*(\\/\\s*[0-9]*\\.?[0-9]*[Ff]?)?\\s+alpha:\\s*([0-9]*\\.?[0-9]*[Ff]?)\\s*(\\/\\s*[0-9]*\\.?[0-9]*[Ff]?)?\\s*\\]" options:0 error:NULL] retain];
